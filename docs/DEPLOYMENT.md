...
Creator is the `$24.99/month` text-AI tier. Full is `$39.99/month`, includes
the complete application, and starts each calendar month with 1,000 image
credits. Every FilmScript image generation reserves and, only on success,
spends 3 credits.
