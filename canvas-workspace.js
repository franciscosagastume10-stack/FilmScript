(function () {
  ...
  class FilmScriptCanvasWorkspace extends HTMLElement {
    ...
    render() {
      ...
      if (!this.state.loading && !this.state.error && this.state.view === 'imagine') requestAnimationFrame(() => this._syncImagineFloatingInset());
