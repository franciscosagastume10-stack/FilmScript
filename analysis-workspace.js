  ...
  render() {
    ...
    const style = `<style>
      ...
      *{box-sizing:border-box}button{font:inherit;color:inherit}svg{width:19px;height:19px}.workspace{width:min(1240px,100%);margin:0 auto;padding:44px 48px 84px}.page-header{display:flex;align-items:flex-end;justify-content:space-between;gap:32px;margin-bottom:34px}.page-title{min-width:0}.section-kicker,.page-kicker{display:block;color:var(--an-accent);font-size:9.5px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase}.page-header h1{max-width:720px;margin:7px 0 9px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:34px;line-height:1.04;letter-spacing:-1.25px;font-weight:650}.title-meta{display:flex;align-items:center;flex-wrap:wrap;gap:9px;color:var(--an-muted);font-size:11.5px}.script-status{display:inline-flex;align-items:center;gap:6px;padding:5px 9px;border-radius:999px;background:var(--an-soft);color:var(--an-ink);font-weight:600}.script-status:before{content:"";width:6px;height:6px;border-radius:50%;background:var(--an-accent)}.script-status.production-ready:before{background:var(--an-positive)}.script-status.needs-attention:before{background:#B45F50}.header-actions{display:flex;align-items:center;gap:14px;flex:0 0 auto}.sync-state{display:flex;align-items:center;gap:7px;max-width:300px;color:var(--an-muted);font-size:10.5px;text-align:right}.sync-state i{width:6px;height:6px;border-radius:50%;background:var(--an-accent)}.sync-state.is-live i{animation:pulse 1.4s ease-in-out infinite}.export,.primary{display:inline-flex;align-items:center;justify-content:center;gap:8px;min-height:40px;padding:0 15px;border:1px solid color-mix(in srgb,var(--an-ink) 42%,var(--an-line));border-radius:11px 9px 12px 10px/9px 12px 10px 11px;background:transparent;font-size:11.5px;font-weight:600;cursor:pointer;transition:transform .16s cubic-bezier(.2,.8,.2,1),border-color .16s ease,background .16s ease}.export:hover{transform:translateY(-1px);border-color:var(--an-accent);background:color-mix(in srgb,var(--an-accent) 5%,transparent)}.export svg{width:16px;height:16px}.primary{border-color:var(--an-accent);background:var(--an-accent);color:#fff}.pro-note,.error{display:flex;align-items:center;justify-content:space-between;gap:12px;margin:0 0 18px;padding:12px 14px;border:1px solid color-mix(in srgb,var(--an-accent) 38%,var(--an-line));border-radius:12px 10px 13px 9px;background:color-mix(in srgb,var(--an-accent) 7%,var(--an-surface));color:var(--an-muted);font-size:11px}.pro-note svg{color:var(--an-accent);flex:0 0 18px}.error{border-color:#B95A55;background:color-mix(in srgb,#B95A55 7%,var(--an-surface));color:#B95A55}.error button{border:0;background:transparent;color:inherit;font-weight:600;cursor:pointer}
      ...
      .analysis-boot-glass{width:min(760px,100%);padding:38px 40px 34px;text-align:left}.analysis-boot-head{display:grid;grid-template-columns:92px minmax(0,1fr);align-items:center;gap:24px}.analysis-boot-head .analysis-orbit{width:92px;height:92px;margin:0}.analysis-boot-head h1{margin:4px 0 8px}.analysis-boot-kicker{display:block;color:var(--an-accent);font-size:9px;font-weight:800;letter-spacing:1.5px;text-transform:uppercase}.analysis-boot-head p{max-width:520px;margin:0;color:var(--an-muted);font-size:11.5px;line-height:1.55}.analysis-boot-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;margin-top:28px}.analysis-boot-card{position:relative;min-height:104px;overflow:hidden;border:1px solid color-mix(in srgb,var(--an-ink) 15%,var(--an-line));border-radius:16px 13px 18px 12px;background:color-mix(in srgb,var(--an-surface) 58%,transparent);box-shadow:inset 0 1px 0 color-mix(in srgb,#fff 58%,transparent);animation:analysisBootCard 1.55s ease-in-out infinite;animation-delay:calc(var(--boot-index,0) * 90ms)}.analysis-boot-card:before{content:"";position:absolute;inset:0;background:linear-gradient(108deg,transparent 18%,color-mix(in srgb,#fff 46%,transparent) 44%,transparent 68%);transform:translateX(-120%);animation:analysisBootShimmer 1.55s ease-in-out infinite;animation-delay:calc(var(--boot-index,0) * 90ms)}.analysis-boot-card i,.analysis-boot-card b,.analysis-boot-card span{position:absolute;left:14px;display:block;border-radius:999px}.analysis-boot-card i{top:15px;width:8px;height:8px;background:var(--an-accent);box-shadow:0 0 0 4px color-mix(in srgb,var(--an-accent) 13%,transparent)}.analysis-boot-card b{top:36px;width:42%;height:7px;background:color-mix(in srgb,var(--an-muted) 17%,transparent)}.analysis-boot-card span{top:59px;width:calc(100% - 28px);height:6px;background:color-mix(in srgb,var(--an-muted) 13%,transparent);box-shadow:0 15px 0 color-mix(in srgb,var(--an-muted) 9%,transparent)}.analysis-boot-status{display:flex;align-items:center;gap:9px;margin-top:18px;color:var(--an-muted);font-size:10px;font-weight:650}.analysis-boot-status:before{content:"";width:8px;height:8px;border-radius:50%;background:var(--an-accent);animation:pulse 1.25s ease-in-out infinite}@keyframes analysisBootCard{0%,100%{transform:translateY(0)}50%{transform:translateY(-3px);border-color:color-mix(in srgb,var(--an-accent) 34%,var(--an-line))}}@keyframes analysisBootShimmer{45%,100%{transform:translateX(120%)}}
      @supports not ((backdrop-filter:blur(1px)) or (-webkit-backdrop-filter:blur(1px))){.analysis-processing-glass{background:var(--an-surface)}}
      @media(prefers-reduced-transparency:reduce){.analysis-processing-glass,.analysis-boot-card{background:var(--an-surface);backdrop-filter:none;-webkit-backdrop-filter:none}.analysis-processing{background:var(--an-bg)}}
      @media(max-width:620px){.analysis-boot-glass{padding:28px 22px}.analysis-boot-head{grid-template-columns:1fr;justify-items:center;text-align:center}.analysis-boot-head p{max-width:400px}.analysis-boot-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
    </style>`;
    if (this.loading) {
      const title = spanish ? 'Preparando tu análisis' : 'Preparing your Analysis';
      const copy = spanish ? 'Conectando el guion actual y organizando sus escenas antes de mostrar los resultados.' : 'Connecting the current screenplay and organizing its scenes before results appear.';
      const status = spanish ? 'Leyendo la estructura del guion…' : 'Reading screenplay structure…';
      const aria = spanish ? 'Cargando el análisis del guion' : 'Loading screenplay Analysis';
      this.shadowRoot.innerHTML = `${style}<main class="analysis-processing" role="status" aria-live="polite" aria-atomic="true" aria-label="${aria}"><section class="analysis-processing-glass analysis-boot-glass"><div class="analysis-boot-head"><div class="analysis-orbit" aria-hidden="true"><i></i><i></i><i></i><span>${icon('insight')}</span></div><div><span class="analysis-boot-kicker">Lumiere · Analysis</span><h1>${title}</h1><p>${copy}</p></div></div><div class="analysis-boot-grid" aria-hidden="true">${Array.from({ length: 6 }, (_, index) => `<div class="analysis-boot-card" style="--boot-index:${index}"><i></i><b></b><span></span></div>`).join('')}</div><div class="analysis-boot-status">${status}</div></section></main>`;
      return;
    }
