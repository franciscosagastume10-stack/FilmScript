...
(() => {
  ...
  const ES = Object.freeze({
    ...
    'Syncing your projects securely.': 'Sincronizando tus proyectos de forma segura.',
    'Sign in to sync your scripts.': 'Inicia sesión para sincronizar tus guiones.',
    'Sign in to sync your projects.': 'Inicia sesión para sincronizar tus proyectos.',
    'Your projects are taking longer than expected. Please try again.': 'Tus proyectos están tardando más de lo esperado. Inténtalo de nuevo.',
    ...
    'We could not sync your projects. Please try again.': 'No pudimos sincronizar tus proyectos. Inténtalo de nuevo.',
    'Could not create a new screenplay.': 'No se pudo crear un guion nuevo.',
    'Could not create a new project.': 'No se pudo crear un proyecto nuevo.',
    ...
    'Could not rename that project. Please try again.': 'No se pudo renombrar ese proyecto. Inténtalo de nuevo.',
    'No scripts yet. Start a new page when you’re ready.': 'Todavía no hay guiones. Empieza una página nueva cuando quieras.',
    'No projects yet. Create one when you’re ready.': 'Todavía no hay proyectos. Crea uno cuando quieras.',
    'Choose a plan →': 'Elegir un plan →',
    ...
    'No projects match': 'Ningún proyecto coincide',
  ...
  const translateDynamic = (value) => {
    ...
    if ((match = value.match(/^No projects match “(.+)”\.$/))) return `Ningún proyecto coincide con “${match[1]}”.`;
