...
export function permissionsForRole(role, cinematicRole = null, explicit = {}) {
  const base = { ...(ROLE_DEFAULTS[normalizeProjectRole(role)] || ROLE_DEFAULTS.viewer) };
  ...
  if (role !== "owner" && !Object.prototype.hasOwnProperty.call(explicit || {}, "budget")) base.budget = "no_access";
  return base;
}
