...
RECURRENTE_CREATOR_AMOUNT_CENTS=2499
RECURRENTE_FULL_AMOUNT_CENTS=3999
```

FilmScript has one Free workspace and two recurring paid plans: Creator at
`$24.99/month` for text AI and Full at `$39.99/month` for the complete app.
Full includes 1,000 image credits per calendar month; each generated image
uses 3 credits. Keep the two Recurrente product ids private in the backend
secret, never in Vercel or browser code.
